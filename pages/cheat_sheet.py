...
def show():
    st.title(f"Streamlit Cheatsheet")
    ...
    col1.subheader('Optimize performance')
    col1.write('Cache data objects')
    col1.code('''
        ...
        >>> st.cache_data.clear()
    ''')
    col1.write('Cache global resources')
    col1.code('''
    ...
    col2.subheader('Personalize apps for users')
    col2.code('''
